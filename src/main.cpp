...
int main(int argc, char* argv[]) {
  ...
  string out_rmse_file_ = argv[3];
  ofstream rmse_file_(out_rmse_file_.c_str(), ofstream::out);
  ...
  vector<MeasurementPackage> gt_pack_list;
...
//   frame)
  ...
  rmse_out = tools.CalculateRMSE(estimations, ground_truth);
  rmse_file_ << rmse_out(0) << "\t";
  rmse_file_ << rmse_out(1) << "\t";
  rmse_file_ << rmse_out(2) << "\t";
  rmse_file_ << rmse_out(3) << "\n";
